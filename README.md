...
2. En cada ronda se presentan ocho preguntas con modelos únicos, garantizando al menos un caso de cada tipo de solución.
...
Una partida dura aproximadamente **80 a 120 segundos** y tiene **8 preguntas sin repetir ejercicios**. El orden de los casos cambia al investigar otra vez.
